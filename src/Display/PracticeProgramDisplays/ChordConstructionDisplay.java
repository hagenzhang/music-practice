...
public class ChordConstructionDisplay extends AbstractPracticeProgramDisplay {

    public ChordConstructionDisplay(JFrame frame) {
        super(frame);
    }
    ...
    public String getInstructionString() {
        return "<html>This program will give a chord type. Write out which intervals are used to build the chord, " +
                "<br>and once you have an answer in mind check the solution.";
    }
    ...
    public void runExercises(PracticeProgram practice, PracticeController controller) {
        ...
        String practiceString = practice.getPracticeCommand();
        ...
        JLabel label = new JLabel(PracticeProgram.getProblem(practiceString));
        label.setFont(new Font("Arial", Font.PLAIN, 20));
        label.setHorizontalAlignment(JLabel.CENTER);
        panel.add(label, gbc);
        ...
        gbc.gridy++;
        JButton button2 = new JButton("Show Solution");
        button2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JLabel solutionLabel = new JLabel("Solution: " + PracticeProgram.getSolution(practiceString));
                solutionLabel.setFont(new Font("Arial", Font.ITALIC, 20));
        ...
        gbc.gridy++;
        JButton button3 = new JButton("Quit Out");
        button3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                controller.end();
            }
