 ...
 */
public class FretboardFamiliarity implements PracticeProgram {

    Random randomGenerator;
    
    public FretboardFamiliarity() {
    ...
    public String getPracticeCommand(Difficulty diff) {
        ...
        return message + "##SOLUTION##No Solution Available, Use a Tuner!";
    }
    ...
    private String generateEasyMode() {
        ...
        int probability = this.randomGenerator.nextInt(10);
    ...
    private String generateRapidMode() {
        String note = generateNote();
        int stringNum = this.randomGenerator.nextInt(6) + 1;
        String stringType = "";
        ...
        String fretLocation = this.randomGenerator.nextInt(2) == 0 ? "0 - 11" : "12 - 23";
    ...
    private String generateNote() {
        ...
        int select = this.randomGenerator.nextInt(notes.length - 1);
        return notes[select];
    }
}
