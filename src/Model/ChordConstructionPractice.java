 ...
 */
public class ChordConstructionPractice extends AbstractPracticeProgram {


    /**
     * Default contructor for a Chord Construction Practice object. Difficulty is set to null, and must be manually set later.
     */
    public ChordConstructionPractice() {
        super();
    }

    /**
     * Contructor for a Chord Construction Practice Program that specifies difficulty.
     * 
     * @param diff Difficulty Level for the user.
     */
    public ChordConstructionPractice(Difficulty diff) {
        super(diff);
    }
